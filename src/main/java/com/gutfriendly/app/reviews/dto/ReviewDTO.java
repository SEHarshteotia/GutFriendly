package com.gutfriendly.app.reviews.dto;
...
public class ReviewDTO {
	...
	public ReviewDTO(int reviewId, int orderId, int shopId, String shopName, String userName, int rating,
			String comment, List<ReviewKeyword> keywords, ReviewType reviewType, int pointsAwarded,
