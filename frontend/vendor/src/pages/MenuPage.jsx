...
export function MenuPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: () => {
      ...
      return vendorApi.updateMenuItem(
        vendor.vendorId,
        selectedShopId,
        editingItemId,
        {
  ...
  const isFormVisible = showForm || editingItemId !== null
      ...
      {isFormVisible && (
        <div className="mb-6 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-3 flex gap-2">
            ...
            <button onClick={closeForm} className="rounded-lg px-4 py-2 text-sm text-gray-600">
              Cancel
            </button>
          </div>
        </div>
